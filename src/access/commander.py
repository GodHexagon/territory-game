...
class Commander:
    ...
    def host(self,
        ...
        def hdl_connected(socket_id: str):
            ...
            try:
                ...
                self.__handle_requests_and_pysher_error(e)
    ...
    def __handle_requests_and_pysher_error(self, e: Exception):
        self.__log("サーバへの接続に失敗しました。ネットワークを確認してください。")
        self.on_errored(e)
